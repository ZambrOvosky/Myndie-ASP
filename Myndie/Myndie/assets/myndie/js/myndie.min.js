! function(t, a) {
  ! function(t) {
      ...
      a.DEFAULT = {
          ...
          function e() {
              o.options.navbarSmall || (o.options.navbarSmall = t(".navbar-myndie").hasClass("navbar-small")), t('[data-toggle="tooltip"]').tooltip({
                  container: "body"
                  ...
                  o.inputsActive(this)
              }), t("input, textarea").filter("[autofocus]:eq(0)").focus(), o.initAjaxForm(), t(".myndie-accordion, .panel-group").find(".collapse").on("shown.bs.collapse", function() {
          ...
          if ("undefined" != typeof t.fn.owlCarousel) {
              ...
              }), t(".myndie-carousel").each(function() {
                  var e = "myndie-carousel-" + a++,
                      o = t(this).attr("data-autoplay"),
          ...
          this.options.parallax && !this.isMobile && ("undefined" != typeof skrollr && "undefined" == typeof this.skrollr && (this.skrollr = skrollr.init({
              smoothScrolling: !1,
              forceHeight: !1
          })), "undefined" != typeof t.fn.jarallax && (t(".myndie-banner-parallax:not(.banner-top) .image").each(function() {
              var a = parseFloat(t(this).attr("data-speed"));
              t(this).jarallax({
                  speed: isNaN(a) ? .4 : a
              })
          }), t(".myndie-banner-parallax.banner-top").each(function() {
          ...
          }), t(".myndie-footer-parallax").each(function() {
              ...
              a.each(function() {
                  var a = t(this),
                      n = {
                          ...
                          template: a.attr("data-twitter-template") || ["<div>", '    <div class="myndie-twitter-icon"><i class="fa fa-twitter"></i></div>', '    <div class="myndie-twitter-date date">', "        <span>{{date}}</span>", "    </div>", '    <div class="myndie-twitter-text">', "       {{tweet}}", "    </div>", "</div>"].join(" "),
                          loadingText: "Loading...",
                          failText: "Failed to load data",
          ...
          a > this.navbarMaxTop && !this.navbarSmall && (this.navbarSmall = !0, t(".navbar-myndie").addClass("navbar-small")), a <= this.navbarMaxTop && this.navbarSmall && (this.navbarSmall = !1, t(".navbar-myndie").removeClass("navbar-small"))
      }, a.prototype.navbarCollapse = function() {
          var a = this;
          a.$document.on("click", ".navbar-myndie [data-toggle=off-canvas]", function() {
              var a = t(".navbar-myndie").find(t(this).attr("data-target")),
                  e = a.hasClass("collapse");
              a[(e ? "remove" : "add") + "Class"]("collapse"), t(".navbar-myndie")[(e ? "add" : "remove") + "Class"]("myndie-navbar-collapsed")
          });
          var e;
          a.$window.on("resize", function() {
              t(".navbar-myndie").addClass("no-transition"), clearTimeout(e), e = setTimeout(function() {
                  t(".navbar-myndie").removeClass("no-transition")
              }, 50)
          }), a.$document.on("click", ".myndie-navbar-collapsed ~ .content-wrap", function() {
              t(".navbar-myndie").find("[data-toggle=off-canvas]").click()
          }), a.options.fadeBetweenPages && t(".page-preloader").length || a.$document.on("click", ".navbar-myndie .dropdown-toggle", function() {
          ...
          t(".navbar-myndie").on("click", ".dropdown-menu .dropdown-toggle", function(a) {
              t(this).parent(".dropdown").toggleClass("open"), a.preventDefault(), a.stopPropagation()
          })
      }, a.prototype.initAjaxForm = function() {
          this.$document.on("submit", ".myndie-form-ajax", function(a) {
              a.preventDefault();
              var e = t(this),
          ...
          "undefined" !== t.fn.hexagonProgress && t(".myndie-hexagon-rating:not(.myndie-hexagon-rating-ready)").each(function() {
              ...
              }), t(this).addClass("myndie-hexagon-rating-ready")
          })
      }, window.myndie = new a(a.DEFAULT)
  }(jQuery), a["true"] = t
}({}, function() {
  return this
}());